...
/obj/structure/table/use_weapon(obj/item/weapon, mob/user, list/click_params)
	...
	if (istype(weapon, /obj/item/melee/energy/blade) ||istype(tool, /obj/item/gun/energy/plasmacutter) || istype(weapon, /obj/item/psychic_power/psiblade/gamma)  || istype(weapon, /obj/item/psychic_power/psiblade/beta)   || istype(weapon, /obj/item/psychic_power/psiblade/alpha))
